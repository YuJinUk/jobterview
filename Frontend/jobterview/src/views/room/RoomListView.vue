        ...
        >
          ...
          <nav aria-label="Page navigation">
            <ul class="pagination justify-content-center">
              <li
                class="page-item"
                :class="{ disabled: currentSendPage === 1 }"
              >
                <a
                  class="page-link"
                  href="#"
                  @click="changeSendPage(1)"
                  aria-label="first"
                >
                  <span aria-hidden="true">&laquo;</span>
                </a>
              ...
              >
                <a
                  class="page-link"
                  href="#"
                  @click="changeSendPage(currentSendPage - 1)"
                  aria-label="Previous"
                >
                  <span aria-hidden="true">&lt;</span>
                </a>
              ...
              <template v-if="currentSendPage === 1">
                <li
                  v-for="firstPageNumber in Math.min(totalSendPage, 3)"
                  :key="firstPageNumber"
                ...
                >
                  <a
                    class="page-link"
                    href="#"
                    @click="changeSendPage(firstPageNumber)"
                    >{{ firstPageNumber }}</a
                  >
                </li>
              </template>
              <template v-else-if="currentSendPage === totalSendPage">
                <li
                  v-for="LastPageNumber in sendLastPageRange"
                  :key="LastPageNumber"
                ...
                >
                  <a
                    class="page-link"
                    href="#"
                    @click="changeSendPage(LastPageNumber)"
                    >{{ LastPageNumber }}</a
                  >
                </li>
              </template>
              <template v-else>
                <li
                  v-for="pageNumber in sendPageRange"
                  :key="pageNumber"
                ...
                >
                  <a
                    class="page-link"
                    href="#"
                    @click="changeSendPage(pageNumber)"
                    >{{ pageNumber }}</a
                  >
                </li>
              </template>
              <li
                class="page-item"
                :class="{ disabled: currentSendPage === totalSendPage }"
              >
                <a
                  class="page-link"
                  href="#"
              ...
              >
                <a
                  class="page-link"
                  href="#"
                  @click="changeSendPage(totalSendPage)"
                  aria-label="Last"
                >
                  <span aria-hidden="true">&raquo;</span>
                </a>
