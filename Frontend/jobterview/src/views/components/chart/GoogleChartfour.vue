  ...
  <div class="main">
    <div class="container1">
      ...
      <div class="eyeResult shadow">
        ...
        <div v-if="getvideo4.result_emotion.eye_movement > 20">
    ...
    <div class="container2">
        <ul class="emotionResult shadow">
          <!-- v-for 때리기 -->
          <li>슬픔 {{ getvideo4.result_emotion.sad }}</li>
          <li>나쁨 {{ getvideo4.result_emotion.disgust }}</li>
          <li>침착 {{ getvideo4.result_emotion.neutral }}</li>
          <li>긴장 {{ getvideo4.result_emotion.fear }} </li>
          <li>화남 {{ getvideo4.result_emotion.angry }} </li>
          <li>행복 {{ getvideo4.result_emotion.happy }} </li>
          <li>놀람 {{ getvideo4.result_emotion.surprise }} </li>
          <li></li>
        </ul>
    </div>
    ...
    <div class="container3">
      <div class="memberScript shadow">
        ...
        <h6> Q1. {{ selectedQuestions[3].content }}</h6>
          <p>
            A. {{ getvideo4.result_emotion.STT_message }}
          </p>
        </div>
      </div>
      <div class="comment shadow" style="height: 70%; margin-top: 30px;">
        <h3>해당 질문에 대한 음성 감정 분석데이터 입니다.</h3>
        - {{ getvideo4.result_emotion.SER }}
      </div>
      <div class="button">
