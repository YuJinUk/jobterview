  ...
  <div class="main">
    ...
    <div>
      <div class="modal-overlay shadow" v-if="!tt" style="display:flex; flex-direction:column; justify-content: center; text-align:center;">
        <div style="text-align: center;">{{ getvideo1.result_emotion.WordCheck.maxnum }}번씩 말씀하신 단어들이에요.</div>
        <br>
          <ul v-for="word in getvideo1.result_emotion.WordCheck.maxcnt" :key="word" style="padding: 0;">
            <li>{{ word }}</li>
          </ul>
...
import SERChart from "./SERChart.vue";
import LineChart from "./LineChart.vue";
import EyeChart from "./EyeChart.vue"
