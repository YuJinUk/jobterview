  ...
  <div class="main">
    <div class="container1">
      ...
      <div class="eyeResult shadow">
        ...
        <div v-if="getvideo1.result_emotion.eye_movement > 20">
    ...
    <div class="container2">
        <ul class="emotionResult shadow">
          <!-- v-for 때리기 -->
          <li>슬픔 {{ getvideo1.result_emotion.sad }}</li>
          <li>나쁨 {{ getvideo1.result_emotion.disgust }}</li>
          <li>침착 {{ getvideo1.result_emotion.neutral }}</li>
          <li>긴장 {{ getvideo1.result_emotion.fear }} </li>
          <li>화남 {{ getvideo1.result_emotion.angry }} </li>
          <li>행복 {{ getvideo1.result_emotion.happy }} </li>
          <li>놀람 {{ getvideo1.result_emotion.surprise }} </li>
          <li></li>
        </ul>
    </div>
