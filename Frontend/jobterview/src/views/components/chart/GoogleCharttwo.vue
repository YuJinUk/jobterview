  ...
  <div class="main">
    ...
    <div class="container3">
      ...
      <div class="memberScript">
        ...
        <h6> Q2. {{ selectedQuestions[1].content }}</h6>
          <p>
    ...
    <div>
      <div class="modal-overlay shadow" v-if="!tt" style="display:flex; flex-direction:column; justify-content: center; text-align:center;">
        <div style="text-align: center;">{{ getvideo2.result_emotion.WordCheck.maxnum }}번씩 말씀하신 단어들이에요.</div>
        <br>
          <ul v-for="word in getvideo2.result_emotion.WordCheck.maxcnt" :key="word" style="padding: 0;">
            <li>{{ word }}</li>
          </ul>
...
import SERCharttwo from "./SERCharttwo.vue";
import LineCharttwo from "./LineCharttwo.vue";
import EyeCharttwo from "./EyeCharttwo.vue"
