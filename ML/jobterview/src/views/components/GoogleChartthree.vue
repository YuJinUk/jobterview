<template>
  <div class="container">
    <div>
      <h2>3번차트</h2>
      <GChart type="PieChart" :options="options" :data="normalizedDatathree" />
    </div>
    <div style="width: 200px; border: 2px solid ccc; padding: 10px;">
      <div v-for="data in getResultDataList[2]" :key="data.id">
...
export default {
  ...
  computed: {
    ...
    normalizedDatathree() {
      ...
      const emotionData = dataList[2].result_emotion;
      if (!emotionData) {
